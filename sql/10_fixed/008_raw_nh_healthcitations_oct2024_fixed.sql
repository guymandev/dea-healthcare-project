DROP TABLE IF EXISTS healthcare_catalog_db.raw_nh_healthcitations_oct2024_fixed;

CREATE EXTERNAL TABLE healthcare_catalog_db.raw_nh_healthcitations_oct2024_fixed (
...
STORED AS TEXTFILE
LOCATION 's3://healthcare-data-lake-gj/raw/nh_healthcitations_oct2024/'
